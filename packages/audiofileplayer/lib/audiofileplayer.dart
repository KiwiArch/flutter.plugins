...
const String setRateMethod = 'setRate';
...
class Audio with WidgetsBindingObserver {
  Audio._path(this._path, this._onComplete, this._onDuration, this._onPosition, this._onError, this._looping,
  ...
  Audio._absolutePath(this._absolutePath, this._onComplete, this._onDuration, this._onPosition, this._onError,
      this._looping, this._playInBackground)
      : _audioId = _uuid.v4(),
        _path = null,
        _audioBytes = null,
        _remoteUrl = null {
  ...
  Audio._byteData(ByteData byteData, this._onComplete, this._onDuration, this._onPosition, this._onError, this._looping,
      this._playInBackground)
      : _audioId = _uuid.v4(),
  ...
  Audio._remoteUrl(this._remoteUrl, this._onComplete, this._onDuration, this._onPosition, this._onError, this._looping,
      this._playInBackground)
      : _audioId = _uuid.v4(),
        _audioBytes = null,
        _path = null,
  ...
  static Audio load(String path,
    ...
    final Audio audio = Audio._path(path, onComplete, onDuration, onPosition, onError, looping, playInBackground)
      .._load();
    return audio;
  }
  ...
  static Audio loadFromAbsolutePath(String path,
      ...
      bool playInBackground = false}) {
    final Audio audio =
        Audio._absolutePath(path, onComplete, onDuration, onPosition, onError, looping, playInBackground).._load();
    return audio;
  }
  ...
  static Audio loadFromByteData(ByteData byteData,
      ...
      bool playInBackground = false}) {
    final Audio audio =
        Audio._byteData(byteData, onComplete, onDuration, onPosition, onError, looping, playInBackground).._load();
    return audio;
  }
  ...
  static Audio loadFromRemoteUrl(String url,
    ...
    final Audio audio = Audio._remoteUrl(url, onComplete, onDuration, onPosition, onError, looping, playInBackground)
      .._load();
    return audio;
  }
  ...
  Future<void> seek(double positionSeconds) async {
    ...
    try {
      await _sendMethodCall(
          _audioId, seekMethod, <String, dynamic>{audioIdKey: _audioId, positionSecondsKey: positionSeconds});
    } on PlatformException catch (e) {
  ...
  Future<void> setRate(double rate) async {
    ...
    try {
      await _sendMethodCall(_audioId, setRateMethod, <String, dynamic>{audioIdKey: _audioId, rateKey: rate});
    } on PlatformException catch (e) {
      if (_usingOnErrorAudios.containsKey(_audioId)) {
        // Audio has an onError callback.
        _usingOnErrorAudios[_audioId]._onError(e.message);
